...
class BDCOM_EPON:
    def __init__(self, ip_address, community, version, core_mac_address, zabbix_url, zabbix_user, zabbix_password):
        ...
        self.snmp_oid_mac_port = "1.3.6.1.2.1.17.7.1.2"
...
# obj = BDCOM_EPON(ip, community_string, version, core_mac_dict, zabbix_url, zabbix_user, zabbix_password)

# print(obj.get_description_ports('All'))
